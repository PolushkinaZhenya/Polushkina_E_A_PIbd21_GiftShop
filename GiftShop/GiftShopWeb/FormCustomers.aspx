...
<body>
    ...
    <div>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetList" TypeName="GiftShopServiceImplementList.Implementations.CustomerServiceList"></asp:ObjectDataSource>
