...
namespace GiftShopView
{
    public class MailClient
    {
        ...
        public static void Connect()
        {
            ...
            response = SendRequest(reader, writer, string.Format("USER {0}", ConfigurationManager.AppSettings["MailLogin"]),
                "Ошибка авторизации, неверный логин");

            response = SendRequest(reader, writer, string.Format("PASS {0}", ConfigurationManager.AppSettings["MailPassword"]),
